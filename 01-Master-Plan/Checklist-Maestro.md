...
| CHK-MKT-01 | Mercado | Cuantificar TAM/SAM/SOM con metodología visible | PENDING | TBD | Assumptions-Register MARKET-M04 | Investigación de mercado | HIGH | Definir metodología bottom-up/top-down |
| CHK-MKT-02 | Mercado | Análisis de competencia en Ensenada | PENDING | TBD | Assumptions-Register MARKET-M05 | — | MEDIUM | Reconocimiento durante Baja 500 |
...
| CHK-OFE-02 | Oferta | Registrar proveedores en el Mapa de Proveedores/Recursos | PENDING | TBD | 05-Operations/Provider-Resource-Map.md (schema only) | CHK-OFE-01 | MEDIUM | Poblar con datos reales tras contacto |
